...
class ResourceManager {
  private:
     ...
     * \note SoundBuffers are loaded into the memory while Musics are streamed
  ...
  public:
     ...
     * \return false If the file doesn't exist or if the extension is not
     * supported. \note Currently supported : Audio and image files supported by
     * SFML, JSON files, and font files (.ttf)
     */
